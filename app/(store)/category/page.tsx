...
//               className={cn(
//                 "flex justify-between items-center w-full p-3 hover:bg-blue-50 rounded-lg cursor-pointer transition-colors",
//                 expandedCategories.includes(category.id) && "bg-blue-50"
//               )}
//             >
...
//               <ul className="ml-10 mt-2 space-y-2 pb-2">
//                 {category.subcategories.map(sub => (
//                   <li key={sub.id}>
//                     <button className="w-full text-left p-2 hover:bg-blue-50 rounded cursor-pointer text-gray-600 hover:text-gray-900 transition-colors">
//                       {sub.name}
//                     </button>
//                   </li>
//                 ))}
...
// }) => {
//   return (
//     <div className={variant === 'mobile' ? "p-5" : ""}>
//       {variant === 'mobile' && (
...
//       <div className={variant === 'mobile' ? "space-y-6" : "grid grid-cols-1 md:grid-cols-3 gap-6"}>
//         {filterOptions.slice(0, -1).map(filter => (
//           <div key={filter.id}>
//             <h4 className="font-medium text-gray-800 mb-3">{filter.label}</h4>
//             <div className={variant === 'mobile' ? "grid grid-cols-2 gap-2" : "space-y-2"}>
...
//             className="px-5 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 w-1/3 mr-2 transition-colors"
//           >
//             Clear All
//           </button>
//           <button
//             onClick={onApplyFilters}
//             className="px-5 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 w-2/3 transition-colors"
//           >
//             Apply Filters
//           </button>
//         </div>
...
//           <button
//             onClick={onClearFilters}
//             className="px-5 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 mr-3 transition-colors"
//           >
//             Clear All
//           </button>
//           <button
...
//           className="flex items-center justify-between px-4 py-2 bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-lg border border-gray-200 transition-colors"
//         >
//           <div className="flex items-center">
...
//                     className={cn(
//                       "w-full flex items-center px-4 py-2 hover:bg-blue-50 cursor-pointer transition-colors",
...
//   return (
//     <button className="flex items-center justify-center p-3 bg-white rounded-lg shadow border border-gray-200 hover:bg-gray-50 transition-colors">
...
//       <aside
//         className={cn(
//           "fixed top-0 left-0 w-85 max-w-sm h-full bg-white z-50 shadow-xl transition-transform duration-300",
...
//             <div className="text-sm text-gray-600">24 products</div>
//           </div>
...
//               className="flex-1 flex items-center justify-center p-3 bg-white rounded-lg shadow border border-gray-200 hover:bg-gray-50 transition-colors"
//             >
...
//               <h1 className="text-3xl font-bold text-gray-900">Laptops & Computers</h1>
//               <p className="text-gray-600 mt-2">Showing 24 products from 128 results</p>
//             </div>
...
//                     className={cn(
//                       "flex items-center justify-between w-full md:w-auto px-4 py-2 rounded-lg border transition-colors",
//                       showDesktopFilters
...
//               {showDesktopFilters && (
//                 <div className={cn(
//                   "filter-container mt-4 pt-4 border-t border-gray-200 transition-all duration-300",
//                   showDesktopFilters ? "block" : "hidden"
//                 )}>
//                   <FilterPanel
//                     filterOptions={filterOptions}
//                     selectedFilters={selectedFilters}
