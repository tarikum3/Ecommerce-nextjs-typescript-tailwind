...
const Searchbar: FC = () => {
  ...
  return (
    <div className="relative flex justify-between border border-primary-2 rounded-xl items-center text-2xl bg-primary text-secondary w-full transition-colors duration-150 ">
