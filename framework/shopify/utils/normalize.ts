...
// import type { Cart, LineItem } from '@framework/types/cart'
// import type { Category } from '@framework/types/site'
import type { Page,Cart, LineItem , Product,Category} from '@framework/types'
import type {
...
import { colorMap } from '@framework/utils'
...
function normalizeLineItem({
  ...
  return {
    ...
    variant: {
      ...
      price:{value:variant?.priceV2?.amount,retailPrice:variant?.compareAtPriceV2?.amount},
    },
